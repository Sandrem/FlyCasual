...
namespace Ship
{
    public class ShipCardInfo
    {
        ...
        public ShipCardInfo(JSONObject ship)
        {
            ...
            //Console.Write("Setting Up Ship Other");
