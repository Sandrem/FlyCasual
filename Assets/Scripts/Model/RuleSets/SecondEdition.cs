        ...
        public override Dictionary<string, string> PreGeneratedAiSquadrons
        {
            get
            {
                return new Dictionary<string, string>()
                {
                    ...
                    { "Two Tubes + Porkins + Gray Sq. Pilot", "{\"name\":\"Two Tubes + Porkins + Gray Sq. Pilot\",\"faction\":\"rebel\",\"points\":200,\"version\":\"0.3.0\",\"pilots\":[{\"name\":\"jekporkins\",\"points\":64,\"ship\":\"xwing\",\"upgrades\":{\"mod\":[\"servomotorsfoils(attack)\"],\"torpedo\":[\"protontorpedoes\"]},\"vendor\":{\"Sandrem.FlyCasual\":{\"skin\":\"Red\"}}},{\"name\":\"benthictwotubes\",\"points\":30,\"ship\":\"uwing\",\"upgrades\":{\"title\":[\"pivotwing(attack)\"],\"system\":[\"advsensors\"],\"crew\":[\"perceptivecopilot\"]},\"vendor\":{\"Sandrem.FlyCasual\":{\"skin\":\"Partisan\"}}},{\"name\":\"graysquadronbomber\",\"points\":47,\"ship\":\"ywing\",\"upgrades\":{\"turret\":[\"ioncannonturret\"],\"bomb\":[\"seismiccharges\"]},\"vendor\":{\"Sandrem.FlyCasual\":{\"skin\":\"Gray\"}}},{\"name\":\"edriotwotubes\",\"points\":60,\"ship\":\"xwing\",\"upgrades\":{\"mod\":[\"servomotorsfoils(attack)\"]},\"vendor\":{\"Sandrem.FlyCasual\":{\"skin\":\"Partisan\"}}}],\"description\":\"Jek Porkins + Servomotor S-Foils (Attack) + Proton Torpedoes\nBenthic Two Tubes + Pivot Wing (Attack) + Advanced Sensors + Perceptive Copilot\nGray Squadron Bomber + Ion Cannon Turret + Seismic Charges\nEdrio Two Tubes + Servomotor S-Foils (Attack)\"}" }
                };
            }
        }
