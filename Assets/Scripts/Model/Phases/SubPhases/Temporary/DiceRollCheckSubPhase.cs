...
namespace SubPhases
{
    ...
    {
        public override List<GameCommandTypes> AllowedGameCommandTypes { get { return new List<GameCommandTypes>() { GameCommandTypes.ConfirmDiceCheck, GameCommandTypes.SyncDiceRerollSelected, GameCommandTypes.SyncDiceResults, GameCommandTypes.AssignManeuver }; } }
