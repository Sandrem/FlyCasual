...
public static class CreditsUI {
    ...
    private static readonly Dictionary<string, string> CreditsData = new Dictionary<string, string>()
    {
        ...
        { "Models", "TerranCmdr, Izaak94, Darksaber, DTM, Warb Null, Rob, Gambler, Nim the Netrunner, Gremlyn, Morvana, FabioOtto, Grediel, Cherrybomb67, Smight, Voiceoftheforce, flipdark95, JonnieLP, Atherin, Captain Tributon, JackJohn2942, danielnavax90s" },
