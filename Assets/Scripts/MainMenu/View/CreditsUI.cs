...
public static class CreditsUI {
    ...
    private static readonly Dictionary<string, string> CreditsData = new Dictionary<string, string>()
    {
        ...
        { "2D Art", "xwingtmgphotography, Matthew Cohen, Brimhorn Battalion, Andreas Bazylewsi, Andrew McCarthy, Odanan, Andrew Lippens, Davish_Krail, edartu, BuffaloChicken" },
