...
namespace UpgradesList
{
	public class Opportunist : GenericUpgrade
	{
		...
		public override void AttachToShip(GenericShip HostShip)
		{
			base.AttachToShip(HostShip);

            HostShip.OnAttackStartAsAttacker += OpportunistAbility;
        }
		
		public void OpportunistAbility()
        {
