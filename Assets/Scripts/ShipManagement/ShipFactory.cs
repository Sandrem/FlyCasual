...
public class ShipFactory {
	...
	//TODO: REWRITE ASAP
	public Ship.GenericShip SpawnShip(ShipConfiguration shipConfig) {
        ...
        newShipContainer.OnMovementStart += Game.MovementTemplates.ApplyMovementRuler;
        newShipContainer.OnMovementStart += Game.MovementTemplates.CallReturnRangeRuler;
        newShipContainer.OnMovementFinish += Game.MovementTemplates.ResetRuler;
