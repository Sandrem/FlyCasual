...
public static class SwarmManager
{
    ...
    public static void CheckActivation()
    {
        ...
        if (!IsActive && Phases.CurrentSubPhase.GetType() == typeof(PlanningSubPhase) && Roster.GetPlayer(Phases.CurrentSubPhase.RequiredPlayer).GetType() == typeof(Players.HumanPlayer))
        {
